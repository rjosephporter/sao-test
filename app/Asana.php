...
class Asana
{
    ...
    public function createSubTask($parentId, $data)
    {
        return $this->curl->post("tasks/{$parentId}/subtasks", ['data' => $data]);
    }

    public function setTaskParent($taskId, $data)
    {
        return $this->curl->post("tasks/{$taskId}/setParent", ['data' => $data]);
    }
